...
const tekstiOsa : string[] = [
  "Olen osallistunut FreeSpace 2 Open pelimoottorin muokkaamiseen osana 'the Source Code Project' (myöhemmin 'SCP') projektia - pelimoottori oli alunperin FreeSpace 2 pelin pelimoottori, jonka julkaisija oli avannut vapaaseen ei-kaupalliseen levitykseen (tosin vain pelimoottorin, ei varsinaista dataa). Aloitin pelin parissa vain pelailemalla, mutta siirryin aika nopeasti muokkaamaan pelin data (ASCII) tiedostoja. Kun pyytämiäni koodimuokkauksia ei toteutettu päätin ohjelmoida kyseessä olevat kohdat itse. Tämä johdatti minut opettelemaan ohjelmointia C/C++ kielillä joilla pelimoottori oli alunperin julkaistu. SCP:ssä tapana oli, että koodiin sai luvan lisätä omia osioita, kunhan ensin korjasi tietyn määrän Mantis-alustalla ilmoitettuja bugeja. Lisäksi kaiken uuden ohjelmakoodin tuli olla 100% taakesepäin yhteensopivaa.",
  "Tämä prosessi tutustutti minut varsin monipuolisesti toimintaan koodin, ohjelmoijien, datan, modaajien, sekä varsinaisten pelaajien välillä. Raportoidut virheet vaihtelivat kaikesta pelaajan omasta tekemisestä aina pelimoottorin keskeisiin osiin saakka (esim. liukulukulaskennan epätarkkuuteen pelimaailman 'ulkorajoilla'). Kävin läpi kaikenlaista pelin varsinaisen logiikan puolella, mutta en juurikaan koskenut grafiikkamoottoriin tai suoraan käyttöjärjestelmäintegraatioon (peli oli alunperin vain Windows pohjainen, mutta muokattiin myös Linux ja Mac yhteensopivaksi SCP projektissa.",
  "Omat muokkaukseni keskittyivät irroittamaan 'kovakoodattuja' ominaisuuksia irti C/C++ koodista ja antamaan nämä modaajien saataville mahdollistamalla näiden tietojen muokkauksen tekstitiedostojen kautta. Lisäsin myös paljon toivottuja ominaisuuksia peliin, ja käsittelin paljon etenkin pelin alusten tekoälyn käyttämiä ominaisuuksia, ja muokkasin myös tekoälyn toimintaa. Lua-skriptauskielen tultua integroiduksi koitin edistää sen käyttöä tuottamalla joitain muokkaajien ja bugin etsintä työkaluja, mutta rakensin myös Lua-parserin, parannetun hiirikontrollin (peli oli suunniteltu joystickille) ja käytin skriptausta efektien lisäämiseen peliin.",
  "Otin osaa useisiin modeihin ja totaalikonversiohin. Autoin myös ratkaisemaan lukuisittain muiden modaajien ja muokkausten aiheuttamia tai muutoin esille tuomia ongelmia ja bugeja."
]
